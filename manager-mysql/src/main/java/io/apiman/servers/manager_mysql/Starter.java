 ...
 */
package io.apiman.servers.manager_mysql;
...
public class Starter {
    ...
    public static void main(String [] args) throws Exception {
        ...
        System.setProperty("apiman.micro.manager.properties-url", new File("src/main/resources/manager_mysql-apiman.properties").toURI().toString());
