 ...
 */
package io.apiman.servers.gateway_file;
...
public class Starter {
    ...
    protected static void loadProperties() {
        URL configUrl = Starter.class.getClassLoader().getResource("gateway_file-apiman.properties");
        if (configUrl == null) {
            throw new RuntimeException("Failed to find properties file (see README.md): gateway_file-apiman.properties");
        }
        InputStream is = null;
        try {
